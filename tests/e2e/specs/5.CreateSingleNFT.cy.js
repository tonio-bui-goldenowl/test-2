describe('Create Single NFT', () => {
    it('Create Single NFT', () => {
        cy.viewport(1920,1080)
        cy.visit({url: 'https://stage-app.plastiks.io/nft/collectibles/new?nft_type=single&role=artist', failOnStatusCode: false});
        cy.wait(5000);
        ...
        cy.get('#itemname').type("Cypress 1")
